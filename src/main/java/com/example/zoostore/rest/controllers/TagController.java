...
public class TagController {
    ...
    public ResponseEntity<EditTagNameResponse> editTagName(@RequestBody EditTagNameRequest request) throws TagNotFoundInRepositoryException, MultimediaNotFoundInRepositoryException, ItemNotFoundInRepositoryException, VendorNotFoundInRepositoryException {
